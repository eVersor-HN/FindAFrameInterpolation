...
- **"Are you still watching?"** Fall asleep mid-film and the player notices. After the time you pick (30–120 min) without a single key, click or remote press, it pauses so you miss nothing and asks. If nobody answers within five minutes it does what you told it to: stay paused, quit, send the PC to sleep, or shut it down. Off by default; both settings live in APP.
